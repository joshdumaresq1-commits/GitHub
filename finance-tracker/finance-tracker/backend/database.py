...
DEFAULT_CATEGORIES = [
    ...
    {"name": "Income Taxes", "color": "#c62828", "budget_monthly": None},
    {"name": "Tailor/Drycleaning", "color": "#6a1fa2", "budget_monthly": 10000},
    {"name": "Pet", "color": "#ef6c00", "budget_monthly": 20000},
    {"name": "Home Improvement", "color": "#558b2f", "budget_monthly": None},
...
DEFAULT_RULES = [
    ...
    # Coffee
    (r"STARBUCKS(?!.*INT|.*POST)|TIM HORTONS|SECOND CUP|TIMOTHY|COFFEE|ESPRESSO|LATTE|APRIL CAFE|CONTINENTAL COFFEE|BAMIGNON|JUSTE|PRET A MANGER|LAVE MOI|SOUPI|BREKA", "Coffee", 22),
    # Drug/Depot
    (r"SHOPPERS DRUG MART|REXALL|PHARMASAVE|GUARDIAN DRUG|LONDON DRUGS|PHARMA|DOLLARAMA|DOLLAR TREE|DOLLAR STORE|JEAN COUTU|PROXIM|FAMILIPRIX", "Drug/Depot", 22),
    # Dining
    (r"MCDONALDS|SUBWAY|A&W|HARVEYS|PIZZA|SUSHI|RESTAURANT|CAFE|DOORDASH|SKIP THE DISHES|UBER.*EATS|WENDY|BURGER KING|POPEYES|KFC|CHIPOTLE|FIVE GUYS|NANDO", "Dining", 20),
    (r"LCBO|THE BEER STORE|WINE RACK|BREWERY|COLD BEER|LIQUOR", "Dining", 15),
    (r"TST-|SQ \*|BAKERY|BOULANGERIE|LIBERTY BAKERY|TAQUERIA|MEZCALERIA|JALAPENO|EARNEST ICE CREAM|HYBAR|CHEZ MARGUERITE|RATP|TERRA BREADS|BRANDON.*JOANNY", "Dining", 18),
    # Subscriptions
    ...
    (r"HOME DEPOT|RONA|KENT BUILDING|REVY|LOWES|LOWE'S|TRUE VALUE|CASTLE BUILD|WINDSOR PLYWOOD|SLEGG LUMBER|HOME HARDWARE|WESTLINE HOMES|CONTRACTOR|PLUMBER|ELECTRICIAN|RENOVATION|HANDYMAN|FLOORING|TILE.*STORE|PAINT.*STORE|CLOVERDALE PAINT|BENJAMIN MOORE", "Home Improvement", 21),
    (r"CRA|CANADA REVENUE|REVENU CANADA|INCOME TAX|TAX INSTALMENT|TAX PAYMENT|IMPOT", "Income Taxes", 22),
    (r"TAILOR|DRY.?CLEAN|DRYCLEAN|LAUNDRY|PRESSING|ALTERATIONS|SHOE REPAIR|COBBLER", "Tailor/Drycleaning", 22),
    (r"BOSLEY|GLOBAL PET|PETLAND|VET|VETERINAR|ANIMAL HOSPITAL|PET SUPPLY|PETSMART|PETCO|PET FOOD|PET SMART|GROOMING.*PET|PET.*GROO", "Pet", 22),
    # Entertainment
