...
DEFAULT_RULES = [
    ...
    (r"COMPASS AUTOLOAD|EVOCARS|EVOSHARE|EVO CAR|CAR SHARE|MODO|ZIPCAR|CHV\d+|OTR \d+", "Transport", 20),
    (r"PARK INDIGO|CONCORD PARKING|DIAMOND PARKING|IMPARK|GREENP|PARKING", "Parking", 20),
    ...
    # Pets
    (r"PETLINE|PET INSURANCE|BOSLEY|GLOBAL PET|PETLAND|VET|VETERINAR|ANIMAL HOSPITAL|PET SUPPLY|PETSMART|PETCO", "Health", 18),
    # Housing
    (r"RENT|HYDRO|ENBRIDGE|ROGERS|BELL|TELUS|SHAW|COGECO|PROPERTY TAX|CONDO FEE|HOA|INTACT|DESJARDINS|AVIVA|TD.*INSURANCE|RBC.*INSURANCE|ELECTRICITY|WATER BILL", "Housing", 20),
    ...
    (r"VISA ROYAL BNK|VISAROYALBNK|BILL PAYMENT-ONLINE VANCITY|E-TRANSFER SENT", "Transfers", 20),
    ...
    (r"STARBUCKS.*INT|STARBUCKS.*POST|FLEXRENT|RBC GRANFONDO|GRANFONDO", "Travel", 15),
]
